...
public class User
{
    ...
    public User()
    {
        AddedTracks = new List<Track>();
        AddedAlbums = new List<Album>();
    }
    ...
    public User(string email, string username, string password, List<Track> addedTracks, List<Album> addedAlbums)
